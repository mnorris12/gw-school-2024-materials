...
from enterprise.signals import white_signals, gp_signals, gp_priors, deterministic_signals
from enterprise_extensions import deterministic, blocks
...
class FeStat(object):
    ...
    def compute_Fe(self, f0, gw_skyloc, tref, brave=False, maximized_parameters=False):
        """
        ...
        for j, gw_pos in enumerate(gw_skyloc.T):
            ...
            for idx, psr in enumerate(self.psrs):
                F_p, F_c, _ = create_gw_antenna_pattern(psr.pos, gw_pos[0], gw_pos[1])
